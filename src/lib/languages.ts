...
export const LANGUAGES: Language[] = [
  ...
  },
  {
    ...
    load: () =>
      stream(async () => ({ parser: (await import('@codemirror/legacy-modes/mode/powershell')).powerShell })),
  },
  {
    id: 'toml',
    label: 'TOML',
  ...
  },
  {
    ...
    load: () =>
      stream(async () => ({ parser: (await import('@codemirror/legacy-modes/mode/properties')).properties })),
  },
  {
    id: 'dockerfile',
    label: 'Dockerfile',
    ...
    load: () =>
      stream(async () => ({ parser: (await import('@codemirror/legacy-modes/mode/dockerfile')).dockerFile })),
  },
  {
    id: 'ruby',
    label: 'Ruby',
  ...
  },
  {
    ...
    extensions: ['hs', 'lhs'],
    load: () =>
      stream(async () => ({ parser: (await import('@codemirror/legacy-modes/mode/haskell')).haskell })),
  },
  {
    id: 'nginx',
    label: 'Nginx',
